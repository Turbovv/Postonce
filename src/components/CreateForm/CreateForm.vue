...
<template>
    ...
    <form @submit.prevent="submitForm" class="submit">
                        <div>
                            <input type="text" class="form-control mb-2" placeholder="Name" v-model="this.title" />
                        </div>
                        <div>
                            <input type="text" class="form-control mb-2" placeholder="County" v-model="this.description" />
                        </div>
        <label for="gif">Choose a GIF:</label>
        <input  type="text" id="gif" v-model="searchQuery" placeholder="Search for a GIF" @input="onInput" autocomplete="off">
        <div v-if="gifs.length" class="gif">
  ...
  import { GiphyType } from '../../types/Giphy.type'    
  export default {
    data() {
      return {
        title: null,
